...
from server.app.api.users import router as users_router  # Import the new users router
...
os.makedirs("uploads/user_profile_images", exist_ok=True)  # New directory for user profile images
...
app.include_router(users_router, prefix="/api/users", tags=["users"])  # Include the users router
